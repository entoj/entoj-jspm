    ...
    describe('#generateConfiguration()', function()
    {
        ...
        it('should generate bundle configs that contains all groups', function()
        {
            const promise = co(function *()
            {
                ...
                expect(baseBundle.common.filename).to.be.equal(pathes.normalizePathSeparators('base/common.js'));
                expect(baseBundle).to.contain.key('core');
                expect(baseBundle.core.filename).to.be.equal(pathes.normalizePathSeparators('base/core.js'));
                expect(extendedBundle).to.contain.key('common');
                expect(extendedBundle.common.filename).to.be.equal(pathes.normalizePathSeparators('extended/common.js'));
                expect(extendedBundle).to.contain.key('core');
                expect(extendedBundle.core.filename).to.be.equal(pathes.normalizePathSeparators('extended/core.js'));
            });
            return promise;
        });
        ...
        it('should allow to customize bundle file pathes', function()
        {
            const promise = co(function *()
            {
                ...
                const baseBundle = bundles[0];
                const extendedBundle = bundles[1];
                expect(baseBundle.common.filename).to.be.equal(pathes.normalizePathSeparators('common.js'));
                expect(baseBundle.core.filename).to.be.equal(pathes.normalizePathSeparators('core.js'));
                expect(extendedBundle.common.filename).to.be.equal(pathes.normalizePathSeparators('common.js'));
                expect(extendedBundle.core.filename).to.be.equal(pathes.normalizePathSeparators('core.js'));
            });
            return promise;
        });
        ...
        it('should generate bundle configs that contains all in/excluded files for a group', function()
        {
            const promise = co(function *()
            {
                ...
                expect(baseBundle.common.include).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'bootstrap.js');
                expect(baseBundle.common.include).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'component.js');
                expect(baseBundle.common.exclude).to.have.length(1);
                expect(baseBundle.common.exclude).to.contain('base' + PATH_SEPERATOR + 'modules' + PATH_SEPERATOR + 'm-teaser' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'm-teaser.js');
                expect(baseBundle.core.include).to.have.length(1);
                expect(baseBundle.core.include).to.contain('base' + PATH_SEPERATOR + 'modules' + PATH_SEPERATOR + 'm-teaser' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'm-teaser.js');
                expect(baseBundle.core.exclude).to.have.length(11);
                expect(baseBundle.core.exclude).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'bootstrap.js');
                expect(baseBundle.core.exclude).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'component.js');
            });
            return promise;
        });
        ...
        it('should generate bundle configs for extended sites that contains all in/excluded files for a group', function()
        {
            const promise = co(function *()
            {
                ...
                expect(extendedBundle.common.include).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'bootstrap.js');
                expect(extendedBundle.common.include).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'component.js');
                expect(extendedBundle.common.include).to.contain('base' + PATH_SEPERATOR + 'elements' + PATH_SEPERATOR + 'e-image' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'e-image.js');
                expect(extendedBundle.common.include).to.contain('extended' + PATH_SEPERATOR + 'elements' + PATH_SEPERATOR + 'e-image' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'e-image.js');
                expect(extendedBundle.common.exclude).to.have.length(1);
                expect(extendedBundle.common.exclude).to.contain('base' + PATH_SEPERATOR + 'modules' + PATH_SEPERATOR + 'm-teaser' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'm-teaser.js');
                expect(extendedBundle.core.include).to.have.length(1);
                expect(extendedBundle.core.include).to.contain('base' + PATH_SEPERATOR + 'modules' + PATH_SEPERATOR + 'm-teaser' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'm-teaser.js');
                expect(extendedBundle.core.exclude).to.have.length(12);
                expect(extendedBundle.core.exclude).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'bootstrap.js');
                expect(extendedBundle.core.exclude).to.contain('base' + PATH_SEPERATOR + 'global' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'component.js');
                expect(extendedBundle.core.exclude).to.contain('base' + PATH_SEPERATOR + 'elements' + PATH_SEPERATOR + 'e-image' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'e-image.js');
                expect(extendedBundle.core.exclude).to.contain('extended' + PATH_SEPERATOR + 'elements' + PATH_SEPERATOR + 'e-image' + PATH_SEPERATOR + 'js' + PATH_SEPERATOR + 'e-image.js');
            });
            return promise;
        });
    });
